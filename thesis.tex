...
\usepackage{listings, listings-rust, listings-json} % Code
\usepackage{xcolor}
\lstset{
    basicstyle=\ttfamily,
...
\begin{enumerate}
% TODO: The terms are not clear yet. What is request, what are updates? Is there no action involved here?
...
\lstset{
  ...
  moredelim=[is][\color{red}\bfseries]{<}{>} % Style text between < and >
}
